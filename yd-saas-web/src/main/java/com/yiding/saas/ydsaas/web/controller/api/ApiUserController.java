...
public class ApiUserController {
     ...
     * @return
     */
    @PostMapping("/getBtnPermsByLoginAccount")
    public Object getBtnPermsByLoginAccount(@RequestBody YdUser ydUser) {
        Set<String> result = userBizService.getBtnPermsByLoginAccount(ydUser.getUserLoginAccount());
