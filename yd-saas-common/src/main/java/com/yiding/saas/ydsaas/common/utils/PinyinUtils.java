...
public class PinyinUtils {
	 ...
	 * @return
	 */
	public static String getTransportNo(String str) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
		return getFirstSpell(str).toUpperCase()+sdf.format(new Date());
	}
...
/*		String str = "你好，123，世界abc,~!#$_Sdf，女；ｈｅｌｌｏ！-";
		...
		String str = "大民屯烟站";
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
		System.out.println(getFirstSpell(str).toUpperCase()+sdf.format(new Date()));
	}
}
